  ...
  `;
    ...
    function switchTab(tabId) {
        ...
        tabButtons.forEach(button => {
            ...
            button.classList.add('border-transparent', 'text-gray-500', 'dark:text-gray-400', 'hover:text-gray-700', 'dark:hover:text-gray-300');
        });
        ...
        if (selectedButton) {
            ...
            selectedButton.classList.remove('border-transparent', 'text-gray-500', 'dark:text-gray-400', 'hover:text-gray-700', 'dark:hover:text-gray-300');
        }
    }
    ...
    async function handleFormSubmit(event) {
        ...
        try {
            ...
            if (response.ok && data.success) {
                ...
                fetchInitialData();
                // Switch to the optimization tab after creating a new configuration
