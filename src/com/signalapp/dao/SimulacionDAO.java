...
/**
 * Data Access Object for the Simulaciones table
 * Handles database operations for simulation entities
 */
public class SimulacionDAO extends BaseDAO<Simulacion> {
    ...
    protected String[] getColumnNames() {
        return new String[] {
                "id_simulaciones", "id_configuraciones", "frecuencia", "tipo_senal",
    ...
    protected Simulacion mapResultSetToEntity(ResultSet rs) throws SQLException {
        return new Simulacion(
                ...
                rs.getString("estado"),
                rs.getString("fecha_simulacion"));
    }

    @Override
    protected void setPreparedStatementParams(PreparedStatement ps, Simulacion entity) throws SQLException {
