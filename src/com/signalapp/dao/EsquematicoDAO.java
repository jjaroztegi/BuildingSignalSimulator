...
/**
 * Data Access Object for the Esquematicos table
 * Handles database operations for schematic entities
 */
public class EsquematicoDAO extends BaseDAO<Esquematico> {
    ...
    protected String[] getColumnNames() {
        return new String[] {
                "id_esquematicos", "id_simulaciones", "piso", "tipo_componente",
    ...
    protected Esquematico mapResultSetToEntity(ResultSet rs) throws SQLException {
        return new Esquematico(
                rs.getInt("id_esquematicos"),
                rs.getInt("id_simulaciones"),
                rs.getInt("piso"),
                rs.getString("tipo_componente"),
                rs.getString("modelo_componente"),
    ...
    @Override
    protected void setPreparedStatementParams(PreparedStatement ps, Esquematico entity) throws SQLException {
     ...
     * @throws SQLException if a database error occurs
     */
    public java.util.List<Esquematico> getBySimulacionAndPiso(int idSimulacion, int piso) throws SQLException {
