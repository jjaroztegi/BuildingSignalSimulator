...
public class Derivador {
    ...
    public double getAtenuacion_paso() { return atenuacion_paso; }
    public void setAtenuacion_paso(double atenuacion_paso) { this.atenuacion_paso = atenuacion_paso; }
    ...
    public double getPerdidas_retorno() { return perdidas_retorno; }
    public void setPerdidas_retorno(double perdidas_retorno) { this.perdidas_retorno = perdidas_retorno; }
} 