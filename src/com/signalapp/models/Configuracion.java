...
public class Configuracion {
    ...
    public double getNivel_cabecera() { return nivel_cabecera; }
    public void setNivel_cabecera(double nivel_cabecera) { this.nivel_cabecera = nivel_cabecera; }
    
    public int getNum_pisos() { return num_pisos; }
    public void setNum_pisos(int num_pisos) { this.num_pisos = num_pisos; }
