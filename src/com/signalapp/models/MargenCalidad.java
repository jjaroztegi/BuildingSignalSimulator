...
public class MargenCalidad {
    ...
    // Getters and Setters
    public int getId_margenes_calidad() { return id_margenes_calidad; }
    public void setId_margenes_calidad(int id_margenes_calidad) { this.id_margenes_calidad = id_margenes_calidad; }
