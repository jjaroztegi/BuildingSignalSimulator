...
public class Coaxial {
    ...
    // Getters and Setters
    public int getId_coaxiales() { return id_coaxiales; }
    public void setId_coaxiales(int id_coaxiales) { this.id_coaxiales = id_coaxiales; }
    ...
    public double getAtenuacion_470mhz() { return atenuacion_470mhz; }
    public void setAtenuacion_470mhz(double atenuacion_470mhz) { this.atenuacion_470mhz = atenuacion_470mhz; }
    
    public double getAtenuacion_694mhz() { return atenuacion_694mhz; }
    public void setAtenuacion_694mhz(double atenuacion_694mhz) { this.atenuacion_694mhz = atenuacion_694mhz; }
} 